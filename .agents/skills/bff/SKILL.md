---
name: Modern.js BFF
description: Layers out the basic foundations for use Modern.js BFF, Basic Usage, Enable BFF, Configure, BFF Functions, Functions Routes, RestFul API Samples, Code Sharing Samples
version: 1.0.0
author: Cod3rKane
license: MIT
prerequisites:
...
metadata:
  hermes:
    tags: [Modern.JS, Project Management, API, Productivity, TypeScript, JavaScript, Programming]
---
